...
**Domain:** focused freelancer operations web app: three work streams, outreach effort tracking, blockers, reminders, and delegation metadata
**Researched:** 2026-04-30
**Confidence:** HIGH for framework/database/auth/UI recommendations; MEDIUM for reminder workflow choice because provider cost and volume need validation after MVP usage.
...
```bash
# Create app
npx create-next-app@latest freelancer-workstream-toolkit --typescript --eslint --tailwind --src-dir --app --import-alias="@/*"

# Core app/data/auth
npm install @supabase/supabase-js @supabase/ssr zod react-hook-form @hookform/resolvers @tanstack/react-query date-fns
...
# Dev/test
npm install -D vitest @testing-library/react @testing-library/jest-dom @playwright/test eslint
```
...
**If building the MVP for one freelancer first:**
...
**If collaboration becomes multi-user in the first milestone:**
...
**If reminders are only in-app at first:**
...
**If offline/mobile use is requested later:**
...
Use these modules as the initial stack-facing boundaries:
...
---
*Stack research for: Freelancer Workstream Toolkit*
*Researched: 2026-04-30*
